...
export {
  ...
  type CandidateFeatureDefinition,
  type CandidateFeatureGroup,
  type CandidateFeatureName,
  type CandidateFeatureProjection,
  type CandidateFeaturesV1,
  type CandidateFeaturesValidationResult,
  type CandidateFeatureValues,
  type CandidateIntentFeatures,
  type CandidateProvenanceFeatures,
  type CandidateShapeFeatures,
