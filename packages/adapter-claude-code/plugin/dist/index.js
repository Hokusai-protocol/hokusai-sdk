...
function isSubmitDataContributionRow(value) {
  ...
  if (value.inputs !== void 0 && !isPlainObject2(value.inputs)) {
    return false;
  }
...
function isTechnicalTaskRouterContributionRowV1(value) {
  ...
  if (!isPlainObject2(value.task_descriptor)) {
    return false;
  }
...
function isHarnessOutcomeRowV1(value) {
  ...
  if (!isPlainObject2(value.task_descriptor) || Object.keys(value.task_descriptor).length === 0) {
    return false;
  }
