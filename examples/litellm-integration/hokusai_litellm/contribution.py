...
INTEGRATION_VERSION = "hokusai-litellm-example/0.1.0"
...
def build_harness_outcome_row(
    *,
    ...
    row: HarnessOutcomeRow = {
        ...
        "selected_models": {"coder": selected_model, "reviewer": selected_model},
        "completion_result": completion_result,
        "wall_clock_seconds": max(0.0, float(latency_ms) / 1000.0),
        "harness": harness,
